...
class WebcontentConverter {
  static const MethodChannel _channel = MethodChannel('web_content_converter');
      ...
      if (io.Platform.isMacOS || io.Platform.isLinux || io.Platform.isWindows) {
        if (WebViewHelper.isChromeAvailable) {
          ...
          try {
            ...
            if (windowBrower == null || windowBrower?.isConnected != true) {
              windowBrower = await pp.puppeteer.launch(
                  headless: true, executablePath: executablePath ?? WebViewHelper.executablePath());
            }
            ...
            results = await windowBrowserPage.screenshot(
              ...
              clip: pp.Rectangle.fromPoints(
                  const pp.Point(0, 0), pp.Point(offsetWidth, offsetHeight)),
              fullPage: false,
              omitBackground: true,
            );
          } finally {
  ...
  static Future<String?> contentToPDF(
    ...
    PdfMargins margins0 = margins ?? PdfMargins.zero;
    final Map<String, dynamic> arguments = {
      'content': content,
      'duration': duration,
      'savedPath': savedPath,
    ...
    try {
      if ((io.Platform.isMacOS || io.Platform.isLinux || io.Platform.isWindows) &&
        ...
        try {
          ...
          windowBrowserPage.setViewport(const pp.DeviceViewport(width: 800, height: 1000));
  ...
  static Future<bool> printPreview({
    ...
    try {
      ...
      if ((io.Platform.isMacOS || io.Platform.isLinux || io.Platform.isWindows) &&
        ...
        page.setViewport(const pp.DeviceViewport(width: 800, height: 1000));
